...
`include "builddate.v"
 ...
 // 0x010
	assign	     console_sel = ((wb_addr[11: 9] &  3'h7) ==  3'h1); // 0x800 - 0x80f
	assign	      wb_sio_sel = ((wb_addr[11: 9] &  3'h7) ==  3'h2); // 0x1000 - 0x101f
//x2	Was a master bus as well
	assign	       bkram_sel = ((wb_addr[11: 9] &  3'h4) ==  3'h4); // 0x2000 - 0x3fff
	//
	...
	assign	      hb_dwb_sel = ((hb_addr[12:12] &  1'h1) ==  1'h0); // 0x0000 - 0x3fff
//x2	Was a master bus as well
	assign	     zip_dbg_sel = ((hb_addr[12:12] &  1'h1) ==  1'h1); // 0x4000 - 0x4007
	//
	...
	always @(posedge i_clk)
		case({		console_ack,
				wb_sio_ack,
				bkram_ack})
			3'b000: wb_many_ack <= 1'b0;
			3'b100: wb_many_ack <= 1'b0;
			3'b010: wb_many_ack <= 1'b0;
			3'b001: wb_many_ack <= 1'b0;
	...
	begin
		casez({		console_ack,
				wb_sio_ack	})
			2'b1?: wb_idata <= console_data;
			2'b01: wb_idata <= wb_sio_data;
...
`ifdef	BUS_DELAY_NEEDED
	busdelay #(12)	hb_dwbi_delay(i_clk,
		hb_dwbi_cyc, hb_dwbi_stb, hb_dwbi_we, hb_dwbi_addr, hb_dwbi_odata, hb_dwbi_sel,
